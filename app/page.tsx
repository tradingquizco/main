    ...
    <div className="h-dvh relative pt-3 ">
      ...
      <div className=" absolute top-[15%] flex items-center justify-around gap-10 w-full max-lg:flex-col max-lg:top-[20%] ">
        <div className="uppercase flex flex-col items-center gap-2">
          <h2 className="text-7xl font-extrabold max-lg:text-3xl">
            tradeing quiz{" "}
          </h2>
          <span className="font-light text-4xl text-slate-700">
            be a real hunter
          </span>
        ...
        <img src="./test.png" alt="" className="max-w-2xl max-md:max-w-96 max-sm:max-w-80" />
      </div>
